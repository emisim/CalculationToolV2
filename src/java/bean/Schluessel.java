...
public class Schluessel implements Serializable {
    ...
    public void setSchluesselType(SchluesselType schluesselType) {
        this.schluesselType = schluesselType;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Schluessel)) {
            return false;
        }
        Schluessel other = (Schluessel) object;
